...
'    ',
'    -- Modifying the enable/disable function to enable/disable the clock button as well as the input field',
'      l_onload_string := l_onload_string || '';'';',
'      l_onload_string := l_onload_string || ''apex.widget.initPageItem('' || l_element_item_id || '', {''',
'                                         || ''	disable : function () {''',
